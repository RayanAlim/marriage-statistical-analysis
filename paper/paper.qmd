...
The data is gathered from the Open Data Toronto portal and cleaned to include relevant fields. We explorde the distribution of marriage licenses over time. The data is graphed in figure (@fig-marli). 
